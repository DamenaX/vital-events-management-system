...
?>
	...
	<td>
		...
		$u="select * from marriagetable where marriagestatus='married'";
        ...
        <legend><h2>wellcome to marriage  information:</h2></legend>
            ...
            <th>marriagestatus</th>
				...
				while($row = mysql_fetch_array($view))
	            {
                    ...
                    echo " <tr><td colspan=10><font size=5>Total number of marriage people in Ethiopia is $rowCheck </td></tr></font>";
    ...
    echo "<font size=5>No Register marriage people in Ethiopia </font>"; 
 echo "</table></form>";
                    ?>
			</div>
			  </td>
