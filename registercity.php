...
<?php
 ...
 $sql="INSERT INTO citytable VALUES('$cityid','$cityname','$woredaid','$regionid','$officerid')";
 $result=mysql_query($sql,$con);
  ...
  ?>
	...
	if($result)
	{
              echo "<font color=green><h2>subcity successfully registered!!!</h2></font>";
              
              	}
			else
			echo "<font color=red><h2> such subcity exist try again!!!</h2></font>".mysql_error($con);
			}
	?>
	<br/><br/>
       <fieldset><legend><font size=5>regiser subcity here!!!</font></legend>
	<form action="" method="post">
<table>
      <tr><td width="140px" height="40px">subcity id</td><td width="140px"  >
		<input type="text" name="cityid" pattern="[A-Za-z0-9]+"  placeholder="subcity_id" style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required> 
		</td><td width="140px" ></td></tr>
      <tr><td width="140px" height="40px"  >subcity name</td><td width="140px" >
	  <input type="text" name="cityname" pattern="[A-Za-z0-9]+" placeholder="subcity_name" style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required >
		</td><td width="140px" ></td></tr>
       ...
       {
      $woredaid=$row["woredaid"];
       $woredaname=$row["woredaname"];
		?>
		<option value="<?php echo $woredaid; ?>"><?php echo $woredaname; ?></option>
		<?php
	     }
		?>
		</select>
	  ...
	  <input type="text" name="officerid" pattern="[A-Za-z0-9]+" placeholder="" value="<?php echo"$id"?>" >
		...
		<tr><td>
	     <input type='submit' name='register' value='registersubcity'  class="btn" ></td><td> 
