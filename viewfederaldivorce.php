	...
	<td>
		...
		<table class="data-table" style="margin-left: 15px;margin-right: 15px;margin-top: 15px;">
		 ...
		 <?php
			...
			$u="select * from divorce where uid='$id'";
		...
		<legend><h2>wellcome to divorce people information:</h2></legend>
			...
			<th>numberofchild</th>
				...
				while($row = mysql_fetch_array($view))
	            {
	            	...
	            	echo "<font size=5> Total number of divorced people in kebele ".$kebele."  is $rowCheck</font>";
	            	
                   
                    
        }
else
    echo "<font size=5 color=red>currently No Register divorce people</font>"; 
                    ?>
                    </form></table>
			</div>
			  </td>
