...
?>
	...
	<td>
		<div id="divContentCenter" >
			<center>
        <legend><font size=5 color=blue><br/><br/>wellcome to population information in<?php echo" $region Region";?></font></legend>
        </center>
		<form>
		...
		$u="select * from birthtable where birthregion='$region'";
				 ...
				 if($rowCheck>0)
                 {
                    ...
                    echo "<table> <tr><td colspan=10><font size=5>Total number of born population in ".$region."  region is  $rowCheck </td></tr></font>";
                   
                   $male="select * from birthtable where  sex='male' and birthregion='$region'";
                 $view=mysql_query($male,$con);
                    $rowmale = mysql_num_rows($view);
                 if($rowmale>0) 
echo " <tr><td colspan=10><font size=3>number of male=   $rowmale </td></tr></font>";

$female="select * from birthtable where  sex='female' and birthregion='$region'";
...
echo " <tr><td colspan=10><font size=3>number of female =  $rowfemal </td></tr></font>";
    ...
    echo "No Register birth people  in $region region"; 
...
<table class="data-table" style="margin-left: 15px;margin-right: 15px;margin-top: 15px;">
     ...
     {
		$sql="select * from birthtable where birthregion='$region'";
