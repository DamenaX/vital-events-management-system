...
?>
	...
	<td>
		...
		$u="select * from divorce";
				...
				while($row = mysql_fetch_array($view))
	            {
                    ...
                    echo "<tr><td colspan=10> <font size=5>Total number of divorce in  ".$region." region is $rowCheck </font></td></tr>";
    ...
    echo "<font size=5 color=red>No Register birth people in  ".$region." region </font>"; 
echo "</table></form>";
                    ?>
