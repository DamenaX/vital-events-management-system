...
?>
		...
		<td>
			<div id="divContentCenter">
		     ...
		     if(isset($_POST['register']))
		     {
				...
				$socialsecurityno=$_POST['socialsecurityno'];
				 $birthstatus=$_POST['birthstatus'];
			//insert data in to the table
		$sql="INSERT INTO birthtable(fname,mname,lname,motherfname,mothermname,sex,birthdate,nationality,registrationdate,birthregion,birthzone,birthcity,birthworeda,birthkebele,uid,statename,countryname,socialsecurityno,statusformrg,birthstatus) values('$babyname','$fathername','$gfather','$mathername','$mathermname','$sex','$bdate','$nation','$regdate','$region','$zone','$city','$woreda','$kebele','$id','$statename','$countryname','$socialsecurityno','unmarried','born')";
		$res= mysql_query($sql,$con);
		  ...
		  ?>
		        ...
		        <legend>birth registration form</legend>
			<form action="federalbirth.php" method="post">
		<table>
		      ...
		      <td>
				...
				<td>
				  state name:
				   ...
				   <td>
				<input type="text" name="statename"    style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required >
				...
				<td>
				 country name:
				   ...
				   <td>
				<input type="text" name="countryname"    style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required >
				...
				<td>
				  socialsecurityno:
				   ...
				   <td>
				<input type="text" name="socialsecurityno"    style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required >
				...
				<td>
				   ...
				   <td>
				<input type="text" name="bdate"    style="font-size:12pt;color:black;border:1px solid gra                  y;paddin          g:2px; width:230px;" value="<?php echo date("d/m/y");?>" >
		...
		<td><input  type="text" name="kebele" style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required  value="<?php echo $kebele;?>" ></td>
					...
					<td>
					  ...
					  <td>
				<input type="text" name="regdate"  placeholder="enter_reg_date " value="<?php echo date("d/m/y");?>"  style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;">
				...
				<td>
				   ...
				   <td>
				<input type="text" name="kooficer"  placeholder="birthstatus "  value="<?php echo $id; ?>" style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required="">
				...
				<td>
				   ...
				   <td>
				<input type="text" name="birthstatus"  placeholder="birthstatus "  value="born" style="font-size:12pt;color:black;border:1px solid gray;padding:2px; width:230px;" required="">
				...
				<td>
			     <input type='submit' name='register' value='registeredoutsidebirth' class="btn">
