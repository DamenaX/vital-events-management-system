...
<!--Php Script-->  
	...
	$u="select * from birthtable where birthstatus='born'";
			$view=mysql_query($u,$con);
					$rowCheck = mysql_num_rows($view);
if($rowCheck<1)
{
echo'<p><font color="red">currently have no has no registerd baby!!</font></p>';
echo' <meta content="5;countkebeletotalpop.php" http-equiv="refresh" />';
}
else
{
		
	echo"<p>ethiopia current total Number of population is:".$rowCheck.'</p>';
