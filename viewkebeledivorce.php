...
?>
<center>
		<legend><font size=5 color=blue><br/><br/>wellcome to divorce people information in <?php echo"$kebele kebele";?></font></legend>
		</center> 
       ...
       echo "</table><table>";
	            	...
	            	echo "<tr><td><font size=5> Total number of divorced people in ".$kebele." kebele  is $rowCheck</font></td></tr>";
	            	
                   
                    
        }
else
    echo "<font size=5>No Register divorce people in ".$kebele." kebele</font>".mysql_error($con); 
                    ?>
                    </table></form>
			</div>
			  </td>
