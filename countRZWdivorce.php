...
if($rowCheck<1)
{
echo'<p><font color="red">currently we have no divorced individual!!</font></p>';
echo' <meta content="5;countkebeledivorce.php" http-equiv="refresh" />';
}
else
{

	echo"<font face='Times New Roman' size='3' color='black'><h2>curently their are ".$rowCheck.' total Number of divorced people in ethiopia:</h2></font>';
