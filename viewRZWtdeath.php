...
<?php
                    ...
                    echo "<tr><td colspan=10><font size=5> Total number of died people  in  ".$woreda." woreda is  $rowCheck </td></tr></font>";
...
<table class="data-table" style="margin-left: 15px;margin-right: 15px;margin-top: 15px;">
     ...
     {
		$sql="select * from deathtable where deathworeda='$woreda'";
