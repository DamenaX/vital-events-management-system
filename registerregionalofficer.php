...
<?php
     ...
     {
		$uid=$_POST['regionofficerid'];
		$ufname=$_POST['regionofficerfname'];
		$umname=$_POST['regionofficermname'];
		$ulname=$_POST['regionofficerlname'];
		...
		$mobile=$_POST['mobile'];
		 $email=($_POST['emails']);
		 $photo=$_POST['photo'];
		 $regionofficerid=$_POST['regionofficerid'];
		 
 $sql="INSERT INTO regionalofficertable VALUES('$uid','$ufname','$umname','$ulname','$sex','$mobile','$email','$photo')";
 $result=mysql_query($sql,$con);
  ...
  ?>
	...
	?>
        <legend> register regional officer</legend>
		<form action="" method="post">
<table>
      <tr><td width="140px" height="40px">regionofficerid</td><td width="140px">
		<input type="text" name="regionofficerid" pattern="[A-Za-z0-9]+"  > 
		</td><td width="140px" ></td></tr>
      <tr><td width="140px" height="40px"  >firstname</td><td width="140px" >
	  <input type="text" name="regionofficerfname" pattern="[A-Za-z0-9]+" placeholder="Enter first username" required="" >
		</td><td width="140px" ></td></tr>
		<tr><td width="140px" height="40px"  >father name</td><td width="140px" >
	  <input type="text" name="regionofficermname" pattern="[A-Za-z0-9]+" placeholder="Enter middle userna me" required="" >
		</td><td width="140px" ></td></tr>
		
		<tr><td width="140px" height="40px" >grand father name</td><td width="140px" >
	  <input type="text" name="regionofficerlname" pattern="[A-Za-z0-9]+" placeholder="Enter last username" required="" >
		</td><td width="140px" ></td></tr>
