...
?>
	...
	<td>
		...
		$u="select * from marriagetable where zone='$zone' and marriagestatus='married'";
...
<tr><th> marriageid</th>
			...
			<th>marragecondition</th>
				...
				while($row = mysql_fetch_array($view))
	            {
	            	...
	            	echo "<tr><td colspan=10><font size=5> Total number of marriage people in  ".$zone." zone is $rowCheck</td></tr></font>";
	            	


    }
    else
    echo "No Register death people in  ".$zone."zone"; 
