...
?>
	...
	$u="select * from divorce where divorcezone='$zone'";
		...
		<legend><h2>wellcome to divorce people information:</h2></legend>
			...
			<th>numberofchild</th>
				...
				while($row = mysql_fetch_array($view))
	            {
	            	...
	            	echo "<font size=5> Total number of divorced people in  ".$zone." zone is $rowCheck </font>";
	            	


    }
    else
    echo "<script>alert('No Register divorce people in  $zone zone')</script>"; 
echo "<tr> </table></form>";
                    ?>
                    			</div>
			  </td>
