...
<div id="divContentCenter">
   <legend><font size=5 color=blue><br/><br/>wellcome to population information in in Ethiopia</font></legend>
        </center>
		<form>
		...
		$u="select * from birthtable";
				 ...
				 if($rowCheck>0)
                 {
                    ...
                    echo "<table> <tr><td colspan=10><font size=5>Total number of born population in ".$nation."  woreda is  $rowCheck </td></tr></font>";
                   
                   $male="select * from birthtable where  sex='male'";
                 $view=mysql_query($male,$con);
                    $rowmale = mysql_num_rows($view);
                 if($rowmale>0) 
echo " <tr><td colspan=10><font size=3>number of male=   $rowmale </td></tr></font>";

$female="select * from birthtable where  sex='female'";
