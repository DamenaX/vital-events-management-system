...
echo' <meta content="5;statcountdivorce.php" http-equiv="refresh" />';
}
else
{

	echo"<font face='Times New Roman' size='3' color='black'><h2>curently their are ".$rowCheck.' total Number of divorced  in ethiopia:</h2></font>';
