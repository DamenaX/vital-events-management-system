...
?>
	...
	<td>
		...
		$u="select * from feedbacktable where role='regionalofficer' And Status='New'";
           	...
           	<?php
				while($row = mysql_fetch_array($view))
	            {
		            	...
		            	echo "<td>".$row['dates']."</td>";
                                 ?>
    <td><?php echo '<a  href="viewkebelefeedback.php?id='.$row['feedbackid'].'">cancel</a>';?></td>
                                 <?php
	            	...
	            	if(isset($_GET['id']))
	            	{
						...
						$updated=mysql_query($upd,$con);
							if(mysql_affected_rows($con))
								echo "<font size=5 color=green>Message Viewed:</font>";
