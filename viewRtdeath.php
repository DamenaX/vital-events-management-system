	...
	<td>
		...
		$u="select * from deathtable where deathworeda='$woreda'";
				 ...
				 if($rowCheck>0)
                 {
                    ?>
                    <center>
        <legend><font size=5><u>death  information in <?php echo"$region region"?></u></font></legend>
        </center>

<?php
 
                    echo "<tr><td colspan=10><font size=5> Total number of died people  in  ".$region." region is  $rowCheck </td></tr></font>";
                   
                    
 $male="select * from deathtable where  sex='male' and deathregion='$region'";
...
$female="select * from deathtable where  sex='female' and deathregion='$region'";
...
echo " <tr><td colspan=10><font size=3>number of died female is $rowfemal </td></tr></font>";
    ...
    echo "<font size=5>No Register died people in  ".$region." region </font>"; 
echo "</table></form>";
                    ?>
<table class="data-table" style="margin-left: 15px;margin-right: 15px;margin-top: 15px;">
     ...
     {
		$sql="select * from deathtable where deathregion='$region'";
